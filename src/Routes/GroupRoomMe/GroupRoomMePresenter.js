...
export default ({
  ...
  if (loading === true) {
    ...
    participants.map((user) => userNameArr.push(user.userName));
    ...
    return (
      <Wrapper>
        ...
        <CoverWrapper>
          ...
          <Section>
            <AvatarBox>
              ...
              {fileLoading && (
                <FadeLoader css={override} size={35} color={"#9ccc65"} />
              )}
              <HiddenInput
                type="file"
                id="fileElem"
            ...
            <CoverContainer>
              ...
              {seeGroupRoom.founderUser.userName === userName ? (
                <ThemeProvider theme={defaultMaterialTheme}>
                  <DialogBox>
                    <AvatarDialogs
                      groupMember={seeGroupRoom.groupRoomMember[0].participants}
                    />
                    <ProgressDialogs
        ...
        <GroupDaughter groupRoomId={groupRoomId} />
      </Wrapper>
    );
  }
};
