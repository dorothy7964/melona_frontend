    ...
    return (
      <Wrapper>
        ...
        {view === "post" ? (
          groupRoom === "none" ? (
            !anotherPage ? (
              <ReplayLink link="/daddy" />
            ) : (
              <ReplayLink link="/daughter" />
            )
          ) : !anotherPage ? (
            <ReplayLink link={`/groupRoom/${groupRoom}`} />
          ) : (
            <ReplayLink link={`/groupRoomMe/${groupRoom}`} />
          )
        ) : (
          <ReplayButton onClick={() => handleAction("", "post")}>
            <Back />
          </ReplayButton>
        )}
        <UserCard
